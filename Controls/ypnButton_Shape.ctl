VERSION 5.00
Begin VB.UserControl ypnButton_Shape 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00000000&
   ClientHeight    =   495
   ...
   ScaleWidth      =   89
End
Attribute VB_Name = "ypnButton_Shape"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = True
'---------------------------------------------------------------------------------------
' Module    : ypnButton_Shape
' Author    : YPN
' Date      : 2018-03-24 00:04
' Purpose   : 可变形的按钮
'             @来源于项目DEEPLOOK，改编自枕善居(mndsoft)
'---------------------------------------------------------------------------------------
...
Private Function ToggleOptionButtons(nMode As Integer) As Boolean
    ...
    If myProps.bValue And (NrCtrls > 0 Or nMode = 1) Then
        ...
        Dim optControl As ypnButton_Shape
        myObjRef = ObjPtr(Me)
        For i = 1 To NrCtrls
