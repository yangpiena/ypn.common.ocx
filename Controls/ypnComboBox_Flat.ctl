VERSION 5.00
Begin VB.UserControl ypnComboBox_Flat 
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   2475
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   151
   ToolboxBitmap   =   "ypnComboBox_Flat.ctx":0000
   ...
   End
End
Attribute VB_Name = "ypnComboBox_Flat"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = True
'---------------------------------------------------------------------------------------
' Module    : ypnComboBox_Flat
' Author    : YPN
' Date      : 2018-03-24 00:10
' Purpose   : ±âÆ½»¯µÄcombox
'---------------------------------------------------------------------------------------
...
Private Const Version As String = "ypnComboBox_Flat 1.0.3 By HACKPRO TM"
...
Private Sub UserControl_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    '* Español: Muestra la lista ?la oculta.
...
Attribute Enabled.VB_Description = "Sets/Gets the Enabled property of the control."
    ...
    '* Español: Devuelve o establece si el Usercontrol esta habilitado ?deshabilitado.
...
Attribute ListPositionShow.VB_Description = "Sets/Gets If the list is shown up or down."
    ...
    '* Español: Devuelve o establece si la lista se muestra hacia arriba ?hacia abajo.
...
Private Sub DrawCtlEdge(ByVal hDC As Long, ByVal X As Single, ByVal Y As Single, ByVal W As Single, ByVal H As Single, Optional ByVal Style As Long = EDGE_RAISED, Optional ByVal flags As Long = BF_RECT)
    ...
    '* Español: Dibuja uno ?más bordes del rectángulo.
    With R
        .Left = X
        .Top = Y
        .Right = X + W
...
Private Sub DrawCtlEdgeByRect(ByVal hDC As Long, ByRef RT As RECT, Optional ByVal Style As Long = EDGE_RAISED, Optional ByVal flags As Long = BF_RECT)
    ...
    '* Español: Colorea uno ?más bordes del rectángulo del Control.
...
Private Sub DrawGradientButton(ByVal WhatGradient As Long)
    ...
    '* Español: Dibuja la apariencia degradada bien sea vertical ?horizontal.
    If (m_StateG = 1) Then
...
Private Function InFocusControl(ByVal ObjecthWnd As Long) As Boolean
    ...
    '* Español: Verifica si el mouse se encuentra sobre el objeto ?si se hace clic fuera de él.
    ...
    '* Español: Coloca el icono del mouse únicamente donde se expande ?retrae la lista.
...
Private Sub IsEnabled(ByVal isTrue As Boolean)
    ...
    '* Español: Muestra el estado de Habilitado ?Deshabilitado del Control.
    If (isTrue = True) Then
        Call DrawAppearance(myAppearanceCombo, 1)
    Else
        Call DrawAppearance(myAppearanceCombo, -1)
