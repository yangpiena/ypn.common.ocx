VERSION 5.00
Begin VB.UserControl ypnListBox_Flat 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   3705
   ClientLeft      =   0
   ...
   FillColor       =   &H80000018&
   FillStyle       =   0  'Solid
   MouseIcon       =   "ypnListBox_Flat.ctx":0000
   ScaleHeight     =   247
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   147
   ToolboxBitmap   =   "ypnListBox_Flat.ctx":030A
End
Attribute VB_Name = "ypnListBox_Flat"
...
'
'               NB : Apart from the vb's inbuilt controls ypnListBox_Flat (hybrid) can
...
'              IMPORTANT:
'                   * In the new version of ypnListBox_Flat, it is not neccessary that you refresh the
...
On Error GoTo handle
    ...
    If Ambient.UserMode = False And m_Items.Count = 0 And m_Mode = Mode_ListBox Then
        m_Items.Add "ypnListBox_Flat" & SPLITER & "-1" & SPLITER & "False"
        m_Selected.Add 0
    End If
